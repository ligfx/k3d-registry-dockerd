...
docker run -p 49156:5000 --name my-registry --network k3d-mytest -d -v /var/run/docker.sock:/var/run/docker.sock -v /var/lib/docker:/var/lib/docker ligfx/my-registry-shim
